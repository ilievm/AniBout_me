...
const getData = async querry => {
  try {
    const response = await axios.get(`https://api.giphy.com/v1/gifs/search?api_key=460KmfK00dmOkN56Jgc649ttFBoZa58a&q=${querry}&limit=25&offset=0&rating=g&lang=en`);
