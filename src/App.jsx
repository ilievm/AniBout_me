...
function App() {
  ...
  async function handleSubmitClick() {
    ...
    const resuresu = makeblob(describeURL);
    console.log(resuresu);
    async function computerVision(resuresu) {
      ...
      //   () => createReadStream('data:image/jpeg;base64,'))).captions[0];
      // console.log(`This may be ${caption.text} (${captionLocal.confidence.toFixed(2)} confidence)`);
    
      const captionLocal = (await computerVisionClient.describeImageInStream(resuresu)).captions[0];
      console.log(`This may be ${captionLocal.text} (${captionLocal.confidence.toFixed(2)} confidence)`);
    
    }
    computerVision(resuresu)
  }
  ...
  return (
    <div className="App">
      ...
      <p>BBATOOON:</p>
      <button onClick={handleSubmitClick}>get array</button>
